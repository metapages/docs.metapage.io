...
const config: Config = {
  title: "Metapages",
  tagline:
    "Simulations, workflows, and apps in the browser. Accelerrated scientific and engineering collaboration.",
    ...
    metadata: [
      {
        name: "keywords",
        content:
          "metapages, javascript, code, workflow, app, evolution, superslides, gestures, hand control, deep time",
      },
    ],
    navbar: {
      title: "",
