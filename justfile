...
# Generate docs and blog from notion
generate: blog docs

# Build documentation (assumed docs and blog are already generated from notion)
build: _ensure_npm_modules _build

# Generate docs and blog from notion, then build
generate-and-build: generate build
...
@blog: _ensure_npm_modules && (_rename_md_mdx "blog") (_highlight_self_in_mermaid "blog") (_truncate_after_END_PAGE "blog") (_remove-right-navigation-selected "blog") (_replace_img_with_markdown "blog") (_fix_p_closing_tag "blog") _extract-og-data
...
open:
    deno run --allow-all https://deno.land/x/metapages@v0.0.27/exec/open_url.ts https://metapages.github.io/load-page-when-available/?url=https://localhost:3000
